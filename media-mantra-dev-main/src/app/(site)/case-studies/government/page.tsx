...
import { GOVERNMENT_CASE_STUDY_INTRO, governmentCaseStudies } from "@/data/case-studies";
...
export const metadata = createMetadata({
  title: "Government Case Studies",
  pathname: "/case-studies/government",
  description: GOVERNMENT_CASE_STUDY_INTRO,
});

/** Government & public affairs case studies */
  ...
  return (
    <main id="main-content" className="flex-1 bg-mm-cream pb-20 pt-8 text-mm-graphite sm:pb-24 sm:pt-10 lg:pt-14">
      <Container>
        ...
        <p className="mt-8 max-w-3xl font-editorial text-base leading-relaxed text-mm-graphite/82 md:mt-10 md:text-[17px] md:leading-[1.75]">
          {GOVERNMENT_CASE_STUDY_INTRO}
        </p>
      </Container>

      <Container className="mt-10 sm:mt-14 md:mt-20">
        <CaseStudiesGrid studies={governmentCaseStudies} />
      </Container>
